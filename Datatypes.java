...
public class Datatypes {
    public static void main(String[] args) {
        ...
        // Java is a statically typed language, which means every variable must have a
        ...
        // 5. Float: (Stores values for decimal points. Sufficient for storing 6 to 7
        // decimals)
        float floatExample = 12.9898f;
        System.out.println("Float Example: " + floatExample);

        // 6. Double: (Stores values for decimal points. Sufficient for storing up to 15
        // to 16 decimals)
